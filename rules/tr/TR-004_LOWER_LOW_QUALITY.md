...
TR-004는 단순히 Lower Low 발생을 평가하지 않는다.

**Lower Low의 품질(Quality)와 추세 붕괴 가능성을 평가하는 Rule이다.**

TR-001(Higher High), TR-002(Higher Low), TR-003(Lower High), TR-004(Lower Low)는
